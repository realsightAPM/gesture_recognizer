...
# Last modified: 2017-06-01 19:16
# Filename: recog_client.py
# Description:
import sys
import json
import time
    ...
    try:
        ...
        while True:
            ...
            if mostPre != mostNow:
                ...
                elif (mostNow != 4 and mostPre == 4 and mostNow != 7) or (mostNow != 4 and mostPre == 7 and mostNow != 7):
                    win32api.mouse_event(win32con.MOUSEEVENTF_LEFTUP, 0, 0, 0, 0)
